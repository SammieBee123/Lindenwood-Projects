 ...
 * Date: 03/2025                           *
 * PURPOSE: AVL tree Node Header file      *
 *******************************************/
...
private:
    ...
    int _height;
public:
  AVLTreeNode(Person value) : _data(value), _left(nullptr), _right(nullptr), _parent(nullptr), _height(1) {}

    Person data() const {return _data;}
    Person& data() {return _data;}
